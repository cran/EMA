...
\bibitem[Huber {\it et~al}., 2002]{vsn}Huber W., Von Heydebreck A., SÃÂ¼ltmann H., Poustka A. and Vingron M. (2002) Variance stabilization applied to microarray data calibration and to the quantification of differential expression.{\it Bioinformatics} 18: suppl. 1 (2002), S96-S104 (ISMB 2002).
